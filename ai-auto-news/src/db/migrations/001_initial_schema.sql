...
-- This documents the base schema that was previously created implicitly in db/index.ts.
-- Run this against a fresh database to set up the schema deterministically.
